...
"}"));
        ...
        line->setGeometry(QRect(7, 440, 951, 20));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);
        label = new QLabel(centralWidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(30, 460, 111, 17));
        label->setStyleSheet(QLatin1String("font: 16pt \"Ubuntu\";\n"
"font-weight: bold;"));
        layoutWidget = new QWidget(centralWidget);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(20, 20, 975, 421));
...
"font: 12pt \"Ubuntu Mono\" bold;"));
        ...
        layoutWidget_1->setGeometry(QRect(40, 480, 933, 235));
        horizontalLayout_6 = new QHBoxLayout(layoutWidget_1);
        ...
        groupBox_ChLst_Ubt = new QGroupBox(layoutWidget_1);
        ...
        groupBox_ChLst_Win = new QGroupBox(layoutWidget_1);
...
"we need to include in the urdf file and the launch folder keeps the ROS launch files.", 0));
        ...
        pushButton_1->setText(QApplication::translate("AsstMainWindow", "PushButton", 0));
        pushButton_2->setText(QApplication::translate("AsstMainWindow", "PushButton", 0));
        pushButton_3->setText(QApplication::translate("AsstMainWindow", "PushButton", 0));
    } // retranslateUi
